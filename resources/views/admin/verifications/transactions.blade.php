                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @elseif($txn->status->value === 'verified' && $txn->agent->phone)
                                    {{--
                                        Build a direct WA link using the agent's phone number.
                                        Format: strip leading 0, prepend Indonesia country code 62.
                                        E.g. 08123456789 → 628123456789
                                    --}}
                                    @php
                                        $waNumber  = preg_replace('/^0/', '62', $txn->agent->phone);
                                        $waMessage = urlencode(
                                            "Halo {$txn->agent->nama}, selamat bergabung di Sahihbodyfeed! " .
                                            "Akun Anda sudah aktif. Silakan login untuk mulai berjualan. 🎉"
                                        );
