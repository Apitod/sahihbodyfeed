                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col">
                            ...
                            <div class="text-primary small font-weight-bold">{{ auth()->user()->agent->status->label() }}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col">
                            ...
                            <div class="text-blue small font-weight-bold">{{ auth()->user()->agent->total_points }} Poin RO
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col">
                            ...
                            <div class="text-green small font-weight-bold">Rp
                                {{ number_format((float) $stats['total_commissions'], 0, ',', '.') }}</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    @if($stats['pending_payouts'] > 0)
        <div class="alert alert-important alert-warning mt-3 border-0 shadow-sm rounded-3">
            <div class="d-flex">
                ...
                <div>
                    Ada <strong>{{ $stats['pending_payouts'] }} Matching Reward</strong> yang sedang tertahan (Pending) karena
                    peringkat Anda belum mencukupi. Tingkatkan poin Anda untuk mencairkannya!
                </div>
            </div>
        </div>
    @endif
